...
public class CrearCuenta extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Nombre para usuario:");

        jLabel3.setFont(new java.awt.Font("Dialog", 0, 16)); // NOI18N
        jLabel3.setText("Contraseña para el usuario: ");
        ...
        btnCrear.setIcon(new javax.swing.ImageIcon("G:\\Mi unidad\\GITHUB\\CURSOS\\BACKEND\\TODO CODE\\04_JAVA\\02_POO\\PROYECTOS\\administradorUsuarios\\administradorUsuarios\\src\\main\\java\\img\\registro.png")); // NOI18N
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            .addComponent(btnLimpiar, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 127, Short.MAX_VALUE)
    ...
    private void btnCrearActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCrearActionPerformed
        ...
        if(txtUsuario.getText().equals("") || 
            ...
            CrearCuenta.mensajeEmergente("Operación errónea", "error", "¡Faltan campos por llenar!");
        } else {
            if (txtContrasenia.getText().equals(txtContraseniaConf.getText())) {
                String usuario = txtUsuario.getText();
                String contrasenia = txtContrasenia.getText();
                String rol = (String) cmbRol.getSelectedItem();
                control.crearCuenta(usuario, contrasenia, rol);
                limpiar();
                CrearCuenta.mensajeEmergente("Operación completada", "info", "¡La cuenta ha sido creada!");
            } else {
                CrearCuenta.mensajeEmergente("Operación errónea", "error", "¡Las contraseñas deben ser iguales!");
            }            
        }
